...
const fakeDetections: DetectionEvent[] = [
    {
        id: "evt_001",
        timestamp: "2026-04-23T12:01:15Z",
        label: "drone",
        confidence: 0.92,
    ...
    {
        id: "evt_002",
        timestamp: "2026-04-23T12:01:17Z",
        label: "drone",
        confidence: 0.87,
        bbox: { x: 200, y: 100, w: 55, h: 38 }
    },
    {
        id: "evt_003",
        timestamp: "2026-04-23T12:01:20Z",
        label: "bird", // noise (model nhầm)
        confidence: 0.65,
        bbox: { x: 300, y: 120, w: 40, h: 30 }
    },
    {
        id: "evt_004",
        timestamp: "2026-04-23T12:01:25Z",
        label: "drone",
        confidence: 0.96,
        bbox: { x: 150, y: 90, w: 70, h: 45 }
    },
    {
        id: "evt_005",
        timestamp: "2026-04-23T12:01:30Z",
        label: "drone",
        confidence: 0.78,
        bbox: { x: 180, y: 110, w: 65, h: 42 }
    },
    {
        id: "evt_006",
        timestamp: "2026-04-23T12:01:35Z",
        label: "plane", // false positive
        confidence: 0.55,
        bbox: { x: 50, y: 60, w: 100, h: 60 }
    },
    {
        id: "evt_007",
        timestamp: "2026-04-23T12:01:40Z",
        label: "drone",
        confidence: 0.89,
        bbox: { x: 220, y: 130, w: 58, h: 36 }
    },
    {
        id: "evt_008",
        timestamp: "2026-04-23T12:01:45Z",
        label: "drone",
        confidence: 0.94,
        bbox: { x: 260, y: 140, w: 62, h: 40 }
    },
    {
        id: "evt_009",
        timestamp: "2026-04-23T12:01:50Z",
        label: "drone",
        confidence: 0.81,
        bbox: { x: 300, y: 150, w: 50, h: 35 }
    },
    {
        id: "evt_010",
        timestamp: "2026-04-23T12:01:55Z",
        label: "helicopter", // edge case
        confidence: 0.6,
        bbox: { x: 100, y: 70, w: 120, h: 80 }
    }
];
